  ...
  const DEMO_STATS: AffiliateStats = {
    ...
    pending: 300,
    sales_list: [
      { id: "sale_demo_1", tier: "starter", amount: 500, commission: 80, status: "paid", created_at: "2026-06-01T10:00:00Z" },
      { id: "sale_demo_2", tier: "pro", amount: 750, commission: 150, status: "pending", created_at: "2026-06-03T14:30:00Z" },
      { id: "sale_demo_3", tier: "business", amount: 1290, commission: 300, status: "pending", created_at: "2026-06-04T09:15:00Z" }
    ]
  }
            ...
            {!code ? (
              ...
              >
                ...
                <p className="text-[var(--text-muted)] mb-6 max-w-md mx-auto">
                  Compartí WabiSend y ganá hasta <span className="text-emerald-400 font-bold">$300 USD</span> por cada licencia vendida. Sin límites, sin techo.
                </p>
                <button
