    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-4 pt-20 pb-16 text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          <a href="#pricing" className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold px-8 py-4 rounded-xl text-lg transition-all hover:scale-105">
      ...
      <div id="pricing" className="max-w-6xl mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center text-white mb-12">Elegí tu licencia</h2>
        <div className="grid md:grid-cols-3 gap-6">
          
          {/* STARTER */}
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 flex flex-col">
            <h3 className="text-lg font-bold text-slate-300">Starter</h3>
            <div className="text-4xl font-extrabold text-white my-4">$500</div>
            <p className="text-slate-400 text-sm mb-6">Perfecto para vendedores individuales.</p>
            <ul className="space-y-3 text-sm text-slate-300 mb-8 flex-1">
              ...
              <li className="text-slate-600">❌ Sin spintax</li>
              <li className="text-slate-600">❌ Sin programación</li>
            </ul>
          ...
          <div className="bg-slate-900 border-2 border-blue-500 rounded-2xl p-6 flex flex-col relative">
            ...
            <div className="text-4xl font-extrabold text-white my-4">$750</div>
            <p className="text-slate-400 text-sm mb-6">Para agencias y equipos de ventas.</p>
            <ul className="space-y-3 text-sm text-slate-300 mb-8 flex-1">
            ...
            <button className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 rounded-xl transition-all hover:scale-105 shadow-lg shadow-blue-900/20">
              Comprar Pro
            </button>
          </div>
          ...
          <div className="bg-slate-900 border border-emerald-500/30 rounded-2xl p-6 flex flex-col">
            ...
            <div className="text-4xl font-extrabold text-white my-4">$1.250</div>
            <p className="text-slate-400 text-sm mb-6">Para resellers y grandes equipos.</p>
            <ul className="space-y-3 text-sm text-slate-300 mb-8 flex-1">
